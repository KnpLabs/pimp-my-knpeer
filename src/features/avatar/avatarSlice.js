...
export const facesList = [Face1, Face2, Face3, Face4, Face5, Face6]
export const eyesList = [Eyes1, Eyes2]
export const mouthsList = [Mouth1, Mouth2, Mouth3, Mouth4, Mouth5]
export const eyeBrowsList = [Eyebrows1, Eyebrows2, Eyebrows3, Eyebrows4, Eyebrows5]
...
export const accessoriesList = [Accessorie1, Accessorie2, Accessorie3]
export const cheeksNosesList = [CheeksNose1, CheeksNose2, CheeksNose3]
export const body = [Body1]
export const background = [Background1]
export const allTheTraits = [
    Face1, 
    Face2, 
    Face3, 
    Face4, 
...
export const faceColors = ['pink1', 'pink2', 'beige1', 'beige2', 'brown1', 'brown2']
export const hairColors = ['blond', 'ginger', 'red', 'brown', 'black', 'grey']
export const bodyColors = ['red', 'pink', 'yellow', 'green', 'blue', 'black']
export const backgroundColors = ['light-purple', 'light-pink', 'light-yellow', 'light-green', 'light-blue', 'light-black']
...
export const avatarSlice = createSlice({
    ...
    reducers: {
        selectTrait: (state, action) => {
            ...
            // state[action.payload.name] = action.payload.trait
        },
    },
})

export const { selectTrait } = avatarSlice.actions;
